...
class FullConeToRestrictedConeNAT:
    ...
    def __init__(self, self_info, peer_info, self_private_key, peer_public_key, log_path):
        ...
        self._keepalive_active = False  # NEW: Keepalive control flag
    ...
    def _punch_hole(self, ports_self, ports_peer):
        ...
        # Hole punch for control channel
        try:
            with socket.socket(socket.AF_INET, socket.SOCK_DGRAM) as ctrl_sock:
                ctrl_sock.bind(('', self.control_port_self))
                ctrl_sock.sendto(b"control-punch", (self.peer_ip, self.control_port_peer))  # Punch for control
    ...
    def _start_keepalive(self):
        """NEW: Maintains NAT mappings with periodic packets"""
    ...
    def _keepalive_worker(self):
        """NEW: Worker for sending periodic keepalives"""
    ...
    def send(self, filepath, chunk_size=8192):
        ...
        keepalive = self._start_keepalive()  # NEW
        ...
        self._keepalive_active = False  # NEW: Cleanup
        keepalive.join()
