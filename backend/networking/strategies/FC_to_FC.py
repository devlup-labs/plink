...
class FullConeToFullConeNAT:
    ...
    def __init__(self, self_info, peer_info, self_private_key, peer_public_key, log_path):
        ...
        log("Session initialized. Control channel established.", LogType.INFO, "Success", self.log_path)
    ...
    def _punch_hole(self, ports_self, ports_peer):
        ...
        log(f"Hole punching complete for {len(ports_self)} data ports.", LogType.INFO, "Success", self.log_path)
